...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams CROSS JOIN games WHERE year=2014 AND round='Eighth-Final' AND (teams.team_id = games.winner_id OR teams.team_id = games.opponent_id)")"
